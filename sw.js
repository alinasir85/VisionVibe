 ...
 * @memberof module:workbox-precaching
 */
class PrecacheStrategy extends Strategy_Strategy {
    /**
     *
     * @param {Object} [options]
     * @param {string} [options.cacheName] Cache name to store and retrieve
 ...
 * @extends module:workbox-routing.Route
 */
class PrecacheRoute extends Route_Route {
    /**
...
function addRoute(options) {
    const precacheController = getOrCreatePrecacheController_getOrCreatePrecacheController();
 ...
 * @memberof module:workbox-precaching
 */
const deleteOutdatedCaches_deleteOutdatedCaches = async (currentPrecacheName, substringToFind = SUBSTRING_TO_FIND) => {
 ...
 * @memberof module:workbox-strategies
 */
class CacheFirst extends Strategy_Strategy {
    /**
     * @private
     * @param {Request|string} request A request to run this strategy for.
     * @param {module:workbox-strategies.StrategyHandler} handler The event that
 ...
 * @memberof module:workbox-strategies
 */
class CacheOnly extends (/* unused pure expression or super */ null && (Strategy)) {
    /**
     * @private
     * @param {Request|string} request A request to run this strategy for.
     * @param {module:workbox-strategies.StrategyHandler} handler The event that
...
const cacheOkAndOpaquePlugin_cacheOkAndOpaquePlugin = {
    /**
 ...
 * @memberof module:workbox-strategies
 */
class NetworkFirst extends (/* unused pure expression or super */ null && (Strategy)) {
    /**
     * @param {Object} [options]
     * @param {string} [options.cacheName] Cache name to store and retrieve
 ...
 * @memberof module:workbox-strategies
 */
class NetworkOnly extends (/* unused pure expression or super */ null && (Strategy)) {
    /**
     * @param {Object} [options]
     * @param {Array<Object>} [options.plugins] [Plugins]{@link https://developers.google.com/web/tools/workbox/guides/using-plugins}
     * to use in conjunction with this caching strategy.
...
let canConstructReadableStream_supportStatus;
/**
 * A utility function that determines whether the current browser supports
...
precacheAndRoute([{'revision':'7315f59812e2de24a393ac4d0efa940a','url':'/404.html'},{'revision':null,'url':'/images/banner-girl-1.24e9b8f48d5a0ac32680edd194503695.png'},{'revision':null,'url':'/images/banner-girl.789f1fa6f451ad26c5039fcbc049ace7.png'},{'revision':null,'url':'/images/banner-guy.fbf4f0f7396fe31ca288dc1dd9822342.png'},{'revision':null,'url':'/images/creditcards.9024dc86450bbd2666b162083f5f91dd.png'},{'revision':null,'url':'/images/defaultAvatar.4e9edb2a624547982816014bf128fcd5.jpg'},{'revision':null,'url':'/images/defaultBanner.accdc757f2c48d61f24c4fbcef2742fd.jpg'},{'revision':null,'url':'/images/logo-full.18070b368a3d226774d46cb028a6f6c0.png'},{'revision':null,'url':'/images/logo-wordmark.18070b368a3d226774d46cb028a6f6